...
NO_INTERS_X = 11;	# east-west dimension of the grid
NO_INTERS_Y = 11;       # north-west dimension of the grid

GRAN = 160; #block size (in m) * 10 (scale) = 1600 m (1 mile)
STEP = 4;  # distance moved at each time step

NO_VEH = 100; # number of vehicles for which trajectories are generated
...
#for rural/city, initialize the first node at same locations as infrastructure (closest to origin) to ensure data gets to ntwk
x_init[0] = 0;
y_init[0] = 0;
